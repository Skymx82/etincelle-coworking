    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8 bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="w-full max-w-2xl bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="flex flex-col md:flex-row">
          {/* Image section */}
          <div className="w-full md:w-2/5 bg-[#C71585] flex items-center justify-center p-8">
          ...
          <div className="w-full md:w-3/5 p-8">
            ...
            <div className="h-1 w-16 bg-[#C71585] mb-6"></div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-[#C71585] flex items-center justify-center mr-3">
                ...
                <a href="tel:+33679336813" className="text-[#C71585] hover:underline font-medium">
                  +33 6 79 33 68 13
                </a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:mattias.mathevon@gmail.com" className="text-[#C71585] hover:underline font-medium">
            ...
            <Link 
              href="/" 
              className="inline-flex items-center bg-[#C71585] text-white font-medium px-5 py-2 rounded-md hover:bg-[#C71585]/80 transition-colors"
            >
