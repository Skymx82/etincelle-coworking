...
const Footer = () => {
  ...
  const footerItems = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Espace membres', href: 'http://intranet.coworking-toulouse.com' },
        { name: 'FAQ', href: '/faq' },
  ...
  const socialLinks = [
    { name: 'Facebook', href: 'https://www.facebook.com/EtincelleCoworking/', icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
      </svg>
    ) },
    { name: 'Twitter', href: 'https://twitter.com/etincelle_tls', icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
      </svg>
    ) },
    { name: 'Instagram', href: 'https://www.instagram.com/etincellecoworking/', icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    { name: 'LinkedIn', href: 'https://www.linkedin.com/company/etincelle-coworking/', icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="w-full lg:w-auto">
              <form className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-white/30 min-w-[250px]"
                  required
                />
                <motion.button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-block mb-6">
              <span className="text-2xl font-bold">Etincelle</span>
              <span className="text-2xl font-light ml-1">Coworking</span>
            </Link>
            <p className="text-gray-400 mb-6">
              Des espaces de travail inspirants à Toulouse et Albi pour les professionnels qui veulent travailler différemment.
            </p>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} Etincelle Coworking. Tous droits réservés.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link href="/cgv" className="text-gray-400 hover:text-white text-sm">
                CGV
              </Link>
            </div>
          </div>
